              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/80 backdrop-blur-md dark:bg-slate-900/80 flex items-center justify-center text-slate-700 dark:text-white shadow-md hover:scale-110 active:scale-95 transition-all cursor-pointer z-10"
                  >
                  ...
                  <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-4">
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-baseline gap-1.5">
                        <span className="text-lg font-bold text-foreground font-sans">₹{service.price}</span>
                        <span className="text-xs text-slate-400 line-through font-sans">₹{service.originalPrice}</span>
                      </div>
                    </div>
